...
export const Footer = () => {
  return (
    <S.Footer>
      ...
      <ul>
        <li>
          <a href="#" title="Clique para acessar o instagram do efood">
            <img src={instagramLogo} alt="Instagram" />
          </a>
        </li>
        <li>
          <a href="#" title="Clique para acessar o facebook do efood">
            <img src={facebookLogo} alt="Facebook" />
          </a>
        </li>
        <li>
          <a href="#" title="Clique para acessar o twitter do efood">
